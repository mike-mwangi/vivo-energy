        ...
        <section class="support-company-area fix pt-6 section-padding2">
            <div class="support-wrapper align-items-end">
                ...
                <div class="right-content">
                    <!-- img -->
                    <div class="right-img">
                        <img src="assets/img/gallery/roles.jpg" alt="">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="assets/img/gallery/vacancies.png" alt="">
                            </div>
                            <div class="team-caption">
                                <li><a href="{{ route('about.vision') }}"><h3>Our Vision</h3></a></li>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="assets/img/gallery/energy.png" alt="">
                            </div>
                            <div class="team-caption">
                                <li><a href="{{ route('about.glance') }}"><h3>At a Glance</h3></a></li>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="assets/img/gallery/why_vivo_others2.png" alt="">
                            </div>
                            <div class="team-caption">
                                <li><a href="{{ route('about.principles') }}"><h3>Our Principles</h3></a></li>
                            </div>
                        </div>
                    </div>
                </div>
